...
var PropertyRow = /** @class */ (function (_super) {
    ...
    function PropertyRow(props) {
        ...
        _this.getLookUpValue = function () {
            var lookupValue = '';
            // Rudimentary validation & error handling.
            if (!_this.state.lookupProperty) {
                lookupValue = 'Please enter an Item Name to look up.';
            }
            else if (_this.state.propertyData[_this.state.lookupProperty] == undefined) {
                lookupValue = 'Specified Item Name is not set.';
            }
            else {
                lookupValue = _this.state.propertyData[_this.state.lookupProperty];
